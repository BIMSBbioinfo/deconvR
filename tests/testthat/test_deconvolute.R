...
test_that("deconvolute nnls", {
  ...
  expect_output(deconvolute(bulk=bulkTable), "SUMMARY OF R-SQUARED VALUES FOR  NNLS : ")
  expect_output(deconvolute(bulk=bulkTable), "SUMMARY OF RESIDUAL-SUM-OF-SQUARES VALUES FOR NNLS :")
...
test_that("deconvolute svr", {
  ...
  expect_output(deconvolute(bulk=bulkTable, model="svr"), "SUMMARY OF R-SQUARED VALUES FOR  SVR : ")
  expect_output(deconvolute(bulk=bulkTable, model="svr"), "SUMMARY OF RESIDUAL-SUM-OF-SQUARES VALUES FOR SVR :")
...
test_that("deconvolute qp", {
  ...
  expect_output(deconvolute(bulk=bulkTable, model="qp"), "SUMMARY OF R-SQUARED VALUES FOR  QP : ")
  expect_output(deconvolute(bulk=bulkTable, model="qp"), "SUMMARY OF RESIDUAL-SUM-OF-SQUARES VALUES FOR QP :")
...
test_that("deconvolute rlm", {
  ...
  expect_output(deconvolute(bulk=bulkTable, model="rlm"), "SUMMARY OF R-SQUARED VALUES FOR  RLM : ")
  expect_output(deconvolute(bulk=bulkTable, model="rlm"), "SUMMARY OF RESIDUAL-SUM-OF-SQUARES VALUES FOR RLM :")
