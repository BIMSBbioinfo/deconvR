...
``` {r, message = FALSE, output.lines=10}
probe_id_locations <- readRDS(system.file("illumina_probes_hg38_GRanges.RDS", package = "deconvR")) %>% as.data.frame()
probe_id_locations
```
...
<details> 
<summary>Limit of Detection & Time Complexity</summary>
