...
extend their reference atlas. Users can create new reference atlases using
...
The **GRanges** object `IlluminaMethEpicB5ProbeIDs` contains the Illumina probe IDs of 400000
genomic loci (identified using the "seqnames", "ranges", and "strand" values).
This object is based off of the Infinium MethylationEPIC v1.0 B5 Manifest data.
